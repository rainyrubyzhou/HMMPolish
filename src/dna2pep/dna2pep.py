...
def openForWriteOrDie(outfile):
	...
	#except IOError, (strerror):
		...
		#print >> sys.stderrsys.stderr, "ERROR - cannot write to the specified file %s [%s]" % (outfile,strerror)
		print("ERROR - cannot write to the specified file %s [%s]" % (outfile,strerror), file = sys.stderrsys.stderr)
		sys.exit(-1)
